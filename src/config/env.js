...
module.exports = {
    ...
    TWILIO_SIP_TRUNK_DOMAIN: process.env.TWILIO_SIP_TRUNK_DOMAIN || '',
    TWILIO_SIP_TRUNK_FRIENDLY_NAME: process.env.TWILIO_SIP_TRUNK_FRIENDLY_NAME || 'Quantum Connects Retell',
    TWILIO_SIP_ORIGINATION_URI: process.env.TWILIO_SIP_ORIGINATION_URI || 'sip:sip.retellai.com;transport=tcp',
    ...
    N8N_USAGE_THRESHOLD_WEBHOOK_URL: process.env.N8N_USAGE_THRESHOLD_WEBHOOK_URL || '',
    N8N_GOOGLE_REVIEW_WEBHOOK_URL: process.env.N8N_GOOGLE_REVIEW_WEBHOOK_URL || '',
    N8N_WAITLIST_WEBHOOK_URL: process.env.N8N_WAITLIST_WEBHOOK_URL || '',
